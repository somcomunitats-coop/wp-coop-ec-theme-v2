...
function wpct_ce_coord_landing_map($remote){
    ...
    if($display_map && $lang === 'ca_ES'){
        ...
        return '<!-- wp:group {"tagName":"section","align":"full","backgroundColor":"main","className":"is-style-no-padding","layout":{"type":"default"}} -->
                ...
                <!-- wp:html -->
                <iframe allowfullscreen="" allow="clipboard-write" id="map" class="h-full w-full" src="https://community-maps.somenergia.coop/ca/somcomunitats/maps/campanya?mapFilters=cat%255B%255D%253Bst%255Ball%255D%253Bcus%255B' . $slug . '%255D&filter=false&fitBoundsCentering=1" width="100%" height="850px" frameborder="0"></iframe><script type="text/javascript" id="community-maps-builder" data-iframe-id="map" src="https://community-maps.somenergia.coop/iframe-integration.js"></script>
                <!-- /wp:html -->
        ...
        return '<!-- wp:group {"tagName":"section","align":"full","backgroundColor":"main","className":"is-style-no-padding","layout":{"type":"default"}} -->
                ...
                <!-- wp:html -->
                <iframe allowfullscreen="" allow="clipboard-write" id="map" class="h-full w-full" src="https://community-maps.somenergia.coop/es/somcomunitats/maps/campanya?mapFilters=cat%255B%255D%253Bst%255Ball%255D%253Bcus%255B' . $slug . '%255D&filter=false&fitBoundsCentering=1" width="100%" height="850px" frameborder="0"></iframe><script type="text/javascript" id="community-maps-builder" data-iframe-id="map" src="https://community-maps-testing.coopdevs.org/iframe-integration.js"></script>
                <!-- /wp:html -->
