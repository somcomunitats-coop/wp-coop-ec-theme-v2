 ...
 * Slug: ce-pattern/ce-news-wide-card
...
<!-- wp:group {"align":"wide","layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"stretch"},"className":"ce-pattern-news-wide-card"} -->
<div class="wp-block-group alignwide ce-pattern-news-wide-card">
  ...
  <!-- /wp:group -->
  <!-- wp:group {"backgroundColor":"base","className":"is-style-padded","layout":{"type":"constrained"}} -->
  <div class="wp-block-group is-style-padded has-base-background-color has-background">
