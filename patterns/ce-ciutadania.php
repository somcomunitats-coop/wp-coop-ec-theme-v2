...
<section class="wp-block-group alignfull is-style-no-padding"><!-- wp:group {"align":"full","className":"is-style-show-desktop","layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"center"}} -->
  <div class="wp-block-group alignfull is-style-show-desktop"><!-- wp:group {"style":{"layout":{"selfStretch":"fixed","flexSize":"40%"}},"layout":{"type":"default"}} -->
    <div class="wp-block-group"><!-- wp:cover {"url":"https://wordpress.local/wp-content/uploads/2023/08/Rectangle-75.png","id":3386,"dimRatio":0,"minHeight":640,"minHeightUnit":"px","isDark":false,"layout":{"type":"constrained"}} -->
      <div class="wp-block-cover is-light" style="min-height:640px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-3386" alt="" src="/wp-content/uploads/2023/08/ciutadania-cover.png" data-object-fit="cover" />
  ...
  <!-- wp:group {"tagName":"section","align":"full","className":"is-style-show-mobile-tablet","layout":{"type":"constrained"}} -->
  <section class="wp-block-group alignfull is-style-show-mobile-tablet"><!-- wp:group {"align":"full","className":"is-style-default","layout":{"type":"flex","orientation":"vertical","flexWrap":"nowrap","justifyContent":"stretch"}} -->
...
<!-- wp:group {"tagName":"section","align":"full","className":"is-style-no-padding"} -->
<section class="wp-block-group alignfull is-style-no-padding" id="ce-reasons"><!-- wp:group {"className":"is-style-show-desktop","layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"stretch"}} -->
  <div class="wp-block-group is-style-show-desktop"><!-- wp:group {"style":{"layout":{"selfStretch":"fixed","flexSize":"60%"}},"className":"is-style-horizontal-padded","layout":{"type":"default"}} -->
    <div id="ce-reasons-icons" class="wp-block-group is-style-horizontal-padded"><!-- wp:spacer {"height":"6rem"} -->
      ...
      <article class="wp-block-group"><!-- wp:image {"id":3406,"width":86,"height":86,"sizeSlug":"full","linkDestination":"none","style":{"layout":{"selfStretch":"fit","flexSize":null}},"className":"is-style-default"} -->
        <figure class="wp-block-image size-full is-resized is-style-default"><img src="/wp-content/uploads/2023/08/impuls-cover-thumbnail.png" alt="" class="wp-image-3406" style="width:86px;height:86px" width="86" height="86" /></figure>
        <!-- /wp:image -->
      ...
      <article class="wp-block-group"><!-- wp:image {"id":3519,"width":90,"height":90,"sizeSlug":"full","linkDestination":"none"} -->
        <figure class="wp-block-image size-full is-resized"><img src="/wp-content/uploads/2023/08/reforca-cover-thumbnail.png" alt="" class="wp-image-3519" style="width:90px;height:90px" width="90" height="90" /></figure>
        <!-- /wp:image -->
      ...
      <article class="wp-block-group"><!-- wp:image {"id":3521,"width":90,"height":90,"sizeSlug":"full","linkDestination":"none"} -->
        <figure class="wp-block-image size-full is-resized"><img src="/wp-content/uploads/2023/08/eines-cover-thumbnail.png" alt="" class="wp-image-3521" style="width:90px;height:90px" width="90" height="90" /></figure>
        <!-- /wp:image -->
  ...
  <!-- wp:group {"tagName":"section","align":"full","className":"is-style-show-mobile-tablet"} -->
  <section class="wp-block-group alignfull is-style-show-mobile-tablet" id="ce-reasons"><!-- wp:group {"className":"is-style-no-padding","layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
    <div class="wp-block-group is-style-no-padding"><!-- wp:group {"style":{"layout":{"selfStretch":"fixed","flexSize":"40%"}},"className":"is-style-no-padding","layout":{"type":"default"}} -->
      <div class="wp-block-group is-style-no-padding"><!-- wp:cover {"url":"https://wordpress.local/wp-content/uploads/2023/08/Frame-39.png","id":3389,"dimRatio":0,"minHeight":430,"minHeightUnit":"px","isDark":false,"style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"className":"is-style-default","layout":{"type":"default"}} -->
        <div class="wp-block-cover is-light is-style-default" style="margin-top:0;margin-bottom:0;min-height:430px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-3389" alt="" src="/wp-content/uploads/2023/07/importancia-comunitat-per-mi.png" data-object-fit="cover" />
          <div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Escriu un títol...","fontSize":"large"} -->
            <p class="has-text-align-center has-large-font-size"></p>
            <!-- /wp:paragraph -->
          </div>
    ...
    <div class="wp-block-columns"><!-- wp:column -->
      <div class="wp-block-column" id="ce-experience"><!-- wp:group {"layout":{"type":"constrained"}} -->
        <div class="wp-block-group"><!-- wp:quote {"backgroundColor":"base","className":"is-style-default"} -->
          ...
          <figure class="wp-block-image size-full" id="ce-comas-background"><img src="/wp-content/uploads/2023/08/comas-background-experience.png" alt="" class="wp-image-3475" /></figure>
          <!-- /wp:image -->
...
<!-- wp:group {"tagName":"section","align":"full","className":"is-style-no-padding"} -->
<section class="wp-block-group alignfull is-style-no-padding"><!-- wp:group {"align":"full","className":"is-style-show-desktop","layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"top"}} -->
  <div class="wp-block-group alignfull is-style-show-desktop"><!-- wp:group {"style":{"layout":{"selfStretch":"fixed","flexSize":"30%"}},"layout":{"type":"constrained"}} -->
  ...
  <!-- wp:group {"tagName":"section","align":"full","className":"is-style-show-mobile-tablet"} -->
  <section class="wp-block-group alignfull is-style-show-mobile-tablet"><!-- wp:group {"align":"full","className":"is-style-no-padding","layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
