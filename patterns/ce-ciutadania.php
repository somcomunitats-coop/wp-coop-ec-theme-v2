...
?>
<!-- wp:group {"tagName":"section","align":"full","className":"is-style-show-desktop is-style-no-padding"} -->
<section class="wp-block-group alignfull is-style-show-desktop is-style-no-padding"><!-- wp:group {"align":"full","className":"is-style-no-padding","layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"center"}} -->
  <div class="wp-block-group alignfull is-style-no-padding"><!-- wp:group {"style":{"layout":{"selfStretch":"fixed","flexSize":"40%"}},"layout":{"type":"default"}} -->
    <div class="wp-block-group"><!-- wp:cover {"url":"https://wordpress.local/wp-content/uploads/2023/08/Rectangle-75.png","id":3386,"dimRatio":0,"minHeight":640,"minHeightUnit":"px","isDark":false,"layout":{"type":"constrained"}} -->
      <div class="wp-block-cover is-light" style="min-height:640px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-3386" alt="" src="https://wordpress.local/wp-content/uploads/2023/08/Rectangle-75.png" data-object-fit="cover" />
...
<!-- wp:group {"tagName":"section","align":"full","className":"is-style-show-mobile-tablet is-style-no-padding","layout":{"type":"constrained"}} -->
<section class="wp-block-group alignfull is-style-show-mobile-tablet is-style-no-padding"><!-- wp:group {"align":"full","className":"is-style-default","layout":{"type":"flex","orientation":"vertical","flexWrap":"nowrap","justifyContent":"center"}} -->
  <div class="wp-block-group alignfull is-style-default"><!-- wp:group {"style":{"layout":{"selfStretch":"fixed","flexSize":"40%"}},"layout":{"type":"default"}} -->
    <div class="wp-block-group"><!-- wp:image {"id":3386,"sizeSlug":"full","linkDestination":"none"} -->
      <figure class="wp-block-image size-full"><img src="https://wordpress.local/wp-content/uploads/2023/08/Rectangle-75.png" alt="" class="wp-image-3386" /></figure>
      <!-- /wp:image -->
    </div>
    <!-- /wp:group -->

    <!-- wp:group {"style":{"layout":{"selfStretch":"fixed","flexSize":"60%"}},"className":"is-style-horizontal-padded","layout":{"type":"constrained","justifyContent":"center","contentSize":""}} -->
    <div class="wp-block-group is-style-horizontal-padded"><!-- wp:spacer {"height":"6rem"} -->
      <div style="height:6rem" aria-hidden="true" class="wp-block-spacer"></div>
      <!-- /wp:spacer -->
...
<!-- wp:group {"tagName":"section","align":"full","backgroundColor":"second-base-light","className":"is-style-no-padding is-style-default","layout":{"type":"constrained","justifyContent":"left"}} -->
<section class="wp-block-group alignfull is-style-no-padding is-style-default has-second-base-light-background-color has-background"><!-- wp:group {"className":"is-style-horizontal-padded","layout":{"type":"default"}} -->
  <div class="wp-block-group is-style-horizontal-padded"><!-- wp:spacer {"height":"6rem"} -->
    <div style="height:6rem" aria-hidden="true" class="wp-block-spacer"></div>
    <!-- /wp:spacer -->

    <!-- wp:heading {"textAlign":"center","textColor":"main"} -->
    <h2 class="wp-block-heading has-text-align-center has-main-color has-text-color">Troba la Comunitat Energètica <br>del teu municipi i suma-t’hi</h2>
    <!-- /wp:heading -->

    <!-- wp:group {"className":"is-style-default","layout":{"type":"default"}} -->
    <div class="wp-block-group is-style-default"><!-- wp:paragraph {"align":"center","textColor":"typography","fontSize":"medium"} -->
      <p class="has-text-align-center has-typography-color has-text-color has-medium-font-size">Ja et pots sumar a la Comunitat Energètica del lloc on vius</p>
      <!-- /wp:paragraph -->
...
<!-- wp:group {"tagName":"section","align":"full","className":"is-style-show-desktop is-style-no-padding"} -->
<section class="wp-block-group alignfull is-style-show-desktop is-style-no-padding" id="ce-reasons"><!-- wp:group {"className":"is-style-no-padding","layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"stretch"}} -->
  <div class="wp-block-group is-style-no-padding"><!-- wp:group {"style":{"layout":{"selfStretch":"fixed","flexSize":"60%"}},"className":"is-style-horizontal-padded","layout":{"type":"default"}} -->
    <div id="ce-reasons-icons" class="wp-block-group is-style-horizontal-padded"><!-- wp:spacer {"height":"6rem"} -->
      <div style="height:6rem" aria-hidden="true" class="wp-block-spacer"></div>
      <!-- /wp:spacer -->
      ...
      <article class="wp-block-group"><!-- wp:image {"id":3406,"width":86,"height":86,"sizeSlug":"full","linkDestination":"none","style":{"layout":{"selfStretch":"fit","flexSize":null}},"className":"is-style-default"} -->
        <figure class="wp-block-image size-full is-resized is-style-default"><img src="https://wordpress.local/wp-content/uploads/2023/08/impuls-cover-thumbnail.png" alt="" class="wp-image-3406" style="width:86px;height:86px" width="86" height="86" /></figure>
        <!-- /wp:image -->
        ...
        <div class="wp-block-group is-style-horizontal-padded"><!-- wp:heading {"level":4} -->
          ...
          <!-- wp:paragraph -->
          <p>Davant la situació actual de canvi climàtic, és vital que les persones, empreses i administracions de cada municipi ens organitzem i passem a l’acció.</p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
      </article>
      ...
      <!-- wp:group {"tagName":"article","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left"}} -->
      <article class="wp-block-group"><!-- wp:image {"id":2118,"width":87,"height":86,"sizeSlug":"full","linkDestination":"none","style":{"layout":{"selfStretch":"fit","flexSize":null}},"className":"is-style-default"} -->
        <figure class="wp-block-image size-full is-resized is-style-default"><img src="/wp-content/uploads/2023/07/servei-cover-thumbnail.png" alt="" class="wp-image-2118" style="width:87px;height:86px" width="87" height="86" /></figure>
        <!-- /wp:image -->

        <!-- wp:group {"className":"is-style-horizontal-padded","layout":{"type":"flex","orientation":"vertical"}} -->
        <div class="wp-block-group is-style-horizontal-padded"><!-- wp:heading {"level":4} -->
          <h4 class="wp-block-heading">Activar múltiples accions energètiques</h4>
          <!-- /wp:heading -->

          <!-- wp:paragraph -->
          <p>Compartir plaques solars, compartir vehicle elèctric, millorar l’eficiència energètica dels habitatges, entre moltes d’altres.</p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
      </article>
      ...
      <!-- wp:group {"tagName":"article","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left"}} -->
      <article class="wp-block-group"><!-- wp:image {"id":2120,"width":90,"height":90,"sizeSlug":"full","linkDestination":"none"} -->
        <figure class="wp-block-image size-full is-resized"><img src="/wp-content/uploads/2023/07/democratitza-cover-thumbnail.png" alt="" class="wp-image-2120" style="width:90px;height:90px" width="90" height="90" /></figure>
        <!-- /wp:image -->
      ...
      <!-- wp:group {"tagName":"article","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left"}} -->
      <article class="wp-block-group"><!-- wp:image {"id":3519,"width":90,"height":90,"sizeSlug":"full","linkDestination":"none"} -->
        <figure class="wp-block-image size-full is-resized"><img src="https://wordpress.local/wp-content/uploads/2023/08/reforca-cover-thumbnail.png" alt="" class="wp-image-3519" style="width:90px;height:90px" width="90" height="90" /></figure>
        <!-- /wp:image -->

        <!-- wp:group {"style":{"layout":{"selfStretch":"fit","flexSize":null}},"className":"is-style-horizontal-padded","layout":{"type":"flex","orientation":"vertical","justifyContent":"left","flexWrap":"wrap"}} -->
        <div class="wp-block-group is-style-horizontal-padded"><!-- wp:heading {"level":4} -->
          <h4 class="wp-block-heading">Reforçar l’economia local i social&nbsp;</h4>
          <!-- /wp:heading -->
        ...
        <!-- wp:spacer {"height":"2em","width":"0px","style":{"layout":{"flexSize":"0px","selfStretch":"fixed"}}} -->
        <div style="height:2em;width:0px" aria-hidden="true" class="wp-block-spacer"></div>
        <!-- /wp:spacer -->
      </article>
      <!-- /wp:group -->
      ...
      <!-- wp:group {"tagName":"article","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left"}} -->
      <article class="wp-block-group"><!-- wp:image {"id":3521,"width":90,"height":90,"sizeSlug":"full","linkDestination":"none"} -->
        <figure class="wp-block-image size-full is-resized"><img src="https://wordpress.local/wp-content/uploads/2023/08/eines-cover-thumbnail.png" alt="" class="wp-image-3521" style="width:90px;height:90px" width="90" height="90" /></figure>
        <!-- /wp:image -->

        <!-- wp:group {"style":{"layout":{"selfStretch":"fit","flexSize":null}},"className":"is-style-horizontal-padded","layout":{"type":"flex","orientation":"vertical","justifyContent":"left","flexWrap":"wrap"}} -->
        <div class="wp-block-group is-style-horizontal-padded"><!-- wp:heading {"level":4} -->
          <h4 class="wp-block-heading">Disposar d’eines i recursos col·lectius</h4>
          <!-- /wp:heading -->

          <!-- wp:paragraph {"style":{"layout":{"selfStretch":"fit","flexSize":null}}} -->
          <p>Utilitzar eines de programari lliure, coneixements i acompanyament per a facilitar la construcció i gestió integral de la Comunitat Energètica.&nbsp;&nbsp;</p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
      ...
      <!-- wp:buttons -->
      <div class="wp-block-buttons"><!-- wp:button {"backgroundColor":"primary","textColor":"main","className":"is-style-rounded","fontSize":"small"} -->
        <div class="wp-block-button has-custom-font-size is-style-rounded has-small-font-size"><a class="wp-block-button__link has-main-color has-primary-background-color has-text-color has-background wp-element-button" href="/comunitats-energetiques/">Què són les Comunitats Energètiques</a></div>
        <!-- /wp:button -->
      </div>
      <!-- /wp:buttons -->
    ...
    <!-- wp:group {"style":{"layout":{"selfStretch":"fixed","flexSize":"40%"}},"className":"is-style-default","layout":{"type":"default"}} -->
    <div class="wp-block-group is-style-default"><!-- wp:cover {"url":"https://wordpress.local/wp-content/uploads/2023/08/Frame-39.png","id":3389,"dimRatio":0,"minHeight":100,"minHeightUnit":"%","isDark":false,"style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"className":"is-style-default","layout":{"type":"default"}} -->
      <div class="wp-block-cover is-light is-style-default" style="margin-top:0;margin-bottom:0;min-height:100%"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-3389" alt="" src="https://wordpress.local/wp-content/uploads/2023/08/Frame-39.png" data-object-fit="cover" />
        <div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Escriu un títol...","fontSize":"large"} -->
          <p class="has-text-align-center has-large-font-size"></p>
          <!-- /wp:paragraph -->
        </div>
...
<!-- wp:group {"tagName":"section","align":"full","className":"is-style-show-mobile-tablet is-style-no-padding"} -->
<section class="wp-block-group alignfull is-style-show-mobile-tablet is-style-no-padding" id="ce-reasons"><!-- wp:group {"className":"is-style-no-padding","layout":{"type":"flex","orientation":"vertical"}} -->
  <div class="wp-block-group is-style-no-padding"><!-- wp:group {"style":{"layout":{"selfStretch":"fit","flexSize":null}},"className":"is-style-default","layout":{"type":"default"}} -->
    <div class="wp-block-group is-style-default"><!-- wp:image {"id":3389,"sizeSlug":"large","linkDestination":"none"} -->
      <figure class="wp-block-image size-large"><img src="https://wordpress.local/wp-content/uploads/2023/08/Frame-39-445x1024.png" alt="" class="wp-image-3389" /></figure>
      <!-- /wp:image -->
    </div>
    <!-- /wp:group -->
...
<section class="wp-block-group alignfull is-style-no-padding has-second-base-light-background-color has-background"><!-- wp:group {"className":"is-style-horizontal-padded","layout":{"type":"default"}} -->
  <div class="wp-block-group is-style-horizontal-padded"><!-- wp:spacer {"height":"6rem"} -->
    ...
    <h2 class="wp-block-heading has-text-align-center">Serveis que ofereixen <br>les Comunitats Energètiques</h2>
    <!-- /wp:heading -->

    <!-- wp:paragraph {"align":"center","fontSize":"medium"} -->
    <p class="has-text-align-center has-medium-font-size">Descobreix tots els serveis energètics i participatius que pot oferir <br>una Comunitat Energètica</p>
    <!-- /wp:paragraph -->
    ...
    <div class="wp-block-columns"><!-- wp:column -->
      <div class="wp-block-column"><!-- wp:group {"layout":{"type":"constrained"}} -->
        <div class="wp-block-group"><!-- wp:image {"align":"center","id":2555,"sizeSlug":"full","linkDestination":"none"} -->
          ...
          <h4 class="wp-block-heading has-text-align-center">Generació renovable comunitària</h4>
          <!-- /wp:heading -->

          <!-- wp:paragraph {"align":"center"} -->
          <p class="has-text-align-center">Energia fotovoltaica, eòlica, hidràulica, biogàs o biomassa, entre altres. <a href="#">Més informació</a></p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
      </div>
      ...
      <div class="wp-block-column"><!-- wp:group {"layout":{"type":"constrained","justifyContent":"center"}} -->
        <div class="wp-block-group"><!-- wp:image {"align":"center","id":2557,"sizeSlug":"full","linkDestination":"none"} -->
          ...
          <!-- wp:heading {"textAlign":"center","level":4} -->
          <h4 class="wp-block-heading has-text-align-center">Mobilitat sostenible</h4>
          <!-- /wp:heading -->

          <!-- wp:paragraph {"align":"center"} -->
          <p class="has-text-align-center">Foment de mobilitat sostenible i compartida (cotxes, bicicletes, furgonetes elèctriques...). <br><a href="#">Més informació</a></p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
      </div>
      ...
      <div class="wp-block-column"><!-- wp:group {"layout":{"type":"constrained"}} -->
        <div class="wp-block-group"><!-- wp:image {"align":"center","id":2559,"width":150,"height":126,"sizeSlug":"full","linkDestination":"none"} -->
          ...
          <!-- wp:heading {"textAlign":"center","level":4} -->
          <h4 class="wp-block-heading has-text-align-center">Eficiència <br>energètica</h4>
          <!-- /wp:heading -->

          <!-- wp:paragraph {"align":"center"} -->
          <p class="has-text-align-center">Millora dels aïllaments d’edificis, electrodomèstics o<br>maquinària més eficient.</p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
      </div>
      ...
      <div class="wp-block-column"><!-- wp:group {"layout":{"type":"constrained"}} -->
        <div class="wp-block-group"><!-- wp:image {"align":"center","id":2561,"width":150,"height":126,"sizeSlug":"full","linkDestination":"none"} -->
          ...
          <!-- wp:heading {"textAlign":"center","level":4} -->
          <h4 class="wp-block-heading has-text-align-center">Formació <br>ciutadana</h4>
          <!-- /wp:heading -->

          <!-- wp:paragraph {"align":"center"} -->
          <p class="has-text-align-center">Aprenentatge i conscienciació en qüestions energètiques,<br>mediambientals i socials.</p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
      </div>
    ...
    <div class="wp-block-columns"><!-- wp:column -->
      <div class="wp-block-column"><!-- wp:group {"layout":{"type":"constrained"}} -->
        <div class="wp-block-group"><!-- wp:image {"align":"center","id":2571,"sizeSlug":"full","linkDestination":"none"} -->
          ...
          <!-- wp:heading {"textAlign":"center","level":4} -->
          <h4 class="wp-block-heading has-text-align-center">Energia tèrmica <br>i climatització</h4>
          <!-- /wp:heading -->

          <!-- wp:paragraph {"align":"center"} -->
          <p class="has-text-align-center">Sisemes renovables (aerotèrmia, biomassa…) a partir de propostes col·lectives.</p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
      </div>
      ...
      <div class="wp-block-column"><!-- wp:group {"layout":{"type":"constrained"}} -->
        <div class="wp-block-group"><!-- wp:image {"align":"center","id":2573,"sizeSlug":"full","linkDestination":"none"} -->
          ...
          <!-- wp:heading {"textAlign":"center","level":4} -->
          <h4 class="wp-block-heading has-text-align-center">Compres <br>col·lectives</h4>
          <!-- /wp:heading -->

          <!-- wp:paragraph {"align":"center"} -->
          <p class="has-text-align-center">Llenya, plaques fotovoltaiques, sistemes d’aerotèrmia, calderes de biomassa, entre d’altres.</p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
      </div>
      ...
      <div class="wp-block-column"><!-- wp:group {"layout":{"type":"constrained"}} -->
        <div class="wp-block-group"><!-- wp:image {"align":"center","id":2577,"width":150,"height":126,"sizeSlug":"full","linkDestination":"none"} -->
          ...
          <!-- wp:heading {"textAlign":"center","level":4} -->
          <h4 class="wp-block-heading has-text-align-center">Subministre d’energia 100% renovable</h4>
          <!-- /wp:heading -->

          <!-- wp:paragraph {"align":"center"} -->
          <p class="has-text-align-center">El subministre d’energia 100% renovable és un dels principals objectius de la Comunitat.</p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
      </div>
      ...
      <div class="wp-block-column"><!-- wp:group {"layout":{"type":"constrained"}} -->
        <div class="wp-block-group"><!-- wp:image {"align":"center","id":2575,"width":150,"height":126,"sizeSlug":"full","linkDestination":"none"} -->
          ...
          <!-- wp:heading {"textAlign":"center","level":4} -->
          <h4 class="wp-block-heading has-text-align-center">Emancipació <br>i transformació</h4>
          <!-- /wp:heading -->

          <!-- wp:paragraph {"align":"center"} -->
          <p class="has-text-align-center">Abandonarem la dependència de les grans empreses que conformen l’oligopoli energètic.</p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
      </div>
...
<section class="wp-block-group alignfull is-style-no-padding has-primary-background-color has-background"><!-- wp:group {"className":"is-style-horizontal-padded","layout":{"type":"default"}} -->
  <div class="wp-block-group is-style-horizontal-padded"><!-- wp:spacer {"height":"6rem"} -->
    ...
    <!-- wp:heading {"textAlign":"center"} -->
    <h2 class="wp-block-heading has-text-align-center">Casos d'èxit</h2>
    <!-- /wp:heading -->

    <!-- wp:paragraph {"align":"center","fontSize":"medium"} -->
    <p class="has-text-align-center has-medium-font-size">Les Comunitats Energètiques que ens inspiren</p>
    <!-- /wp:paragraph -->
    ...
    <div class="wp-block-group is-style-no-padding"><!-- wp:ce-block/slider {"slidesToScroll":3,"slidesToShow":3} -->
      <div class="wp-block-ce-block-slider" infinite="true" centermode="false" slidestoshow="3" slidestoscroll="3" initialslide="0" showdots="false" showarrows="true" autoplay><!-- wp:group {"lock":{"move":false,"remove":false},"className":"ce-block-slider-wrapper","layout":{"type":"flex","orientation":"horizontal"}} -->
        <div class="wp-block-group ce-block-slider-wrapper"><!-- wp:query {"queryId":18,"query":{"perPage":10,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true}} -->
    ...
    <div class="wp-block-buttons"><!-- wp:button {"backgroundColor":"typography","textColor":"primary"} -->
      <div class="wp-block-button"><a class="wp-block-button__link has-primary-color has-typography-background-color has-text-color has-background wp-element-button" href="/comunitats-energetiques/">Coneix les Comunitats Energètiques</a></div>
      <!-- /wp:button -->
    </div>
    <!-- /wp:buttons -->
...
<!-- wp:group {"tagName":"section","align":"full","backgroundColor":"second-base-light","className":"is-style-no-padding","layout":{"type":"constrained"}} -->
<section class="wp-block-group alignfull is-style-no-padding has-second-base-light-background-color has-background" id="ce-experiences"><!-- wp:group {"className":"is-style-horizontal-padded","layout":{"type":"default"}} -->
  <div class="wp-block-group is-style-horizontal-padded"><!-- wp:spacer {"height":"6rem"} -->
    <div style="height:6rem" aria-hidden="true" class="wp-block-spacer"></div>
    <!-- /wp:spacer -->

    <!-- wp:heading {"textAlign":"center"} -->
    <h2 class="wp-block-heading has-text-align-center">Experiències</h2>
    <!-- /wp:heading -->

    <!-- wp:paragraph {"align":"center","fontSize":"medium"} -->
    <p class="has-text-align-center has-medium-font-size">Les pioneres ens comparteixen les seves vivencies</p>
    <!-- /wp:paragraph -->
    ...
    <!-- wp:columns -->
    <div class="wp-block-columns"><!-- wp:column -->
      <div class="wp-block-column" id="ce-experience"><!-- wp:group {"layout":{"type":"constrained"}} -->
        <div class="wp-block-group"><!-- wp:quote {"backgroundColor":"base","className":"is-style-default"} -->
          <blockquote class="wp-block-quote is-style-default has-base-background-color has-background"><!-- wp:paragraph -->
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam in semper odio, eget ullamcorper odio.</p>
            <!-- /wp:paragraph -->
          </blockquote>
          <!-- /wp:quote -->

          <!-- wp:image {"id":3475,"sizeSlug":"full","linkDestination":"none"} -->
          <figure class="wp-block-image size-full" id="ce-comas-background"><img src="https://wordpress.local/wp-content/uploads/2023/08/comas-background-experience.png" alt="" class="wp-image-3475" /></figure>
          <!-- /wp:image -->
          ...
          <!-- wp:heading {"textAlign":"center","level":4} -->
          <h4 class="wp-block-heading has-text-align-center">Lluc Casanou</h4>
          <!-- /wp:heading -->

          <!-- wp:paragraph {"align":"center","fontSize":"x-small"} -->
          <p class="has-text-align-center has-x-small-font-size">Comunitat Energètica</p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
      </div>
      ...
      <div class="wp-block-column" id="ce-experience"><!-- wp:group {"layout":{"type":"constrained"}} -->
        <div class="wp-block-group"><!-- wp:quote {"backgroundColor":"base","className":"is-style-default"} -->
          ...
          <!-- wp:heading {"textAlign":"center","level":4} -->
          <h4 class="wp-block-heading has-text-align-center">Bruna Escriu</h4>
          <!-- /wp:heading -->
      ...
      <div class="wp-block-column" id="ce-experience"><!-- wp:group {"layout":{"type":"constrained"}} -->
        <div class="wp-block-group"><!-- wp:quote {"backgroundColor":"base","className":"is-style-default"} -->
          ...
          <!-- wp:heading {"textAlign":"center","level":4} -->
          <h4 class="wp-block-heading has-text-align-center">Blau Cos</h4>
          <!-- /wp:heading -->
...
<!-- wp:group {"tagName":"section","align":"full","className":"is-style-show-desktop is-style-no-padding"} -->
<section class="wp-block-group alignfull is-style-show-desktop is-style-no-padding"><!-- wp:group {"align":"full","className":"is-style-no-padding","layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"top"}} -->
  <div class="wp-block-group alignfull is-style-no-padding"><!-- wp:group {"style":{"layout":{"selfStretch":"fixed","flexSize":"30%"}},"layout":{"type":"constrained"}} -->
    <div class="wp-block-group"><!-- wp:cover {"url":"/wp-content/uploads/2023/07/faqs.png","id":2585,"dimRatio":0,"minHeight":110,"minHeightUnit":"vh","isDark":false,"layout":{"type":"constrained"}} -->
      <div class="wp-block-cover is-light" style="min-height:110vh"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-2585" alt="" src="/wp-content/uploads/2023/07/faqs.png" data-object-fit="cover" />
        <div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Escriu un títol...","fontSize":"large"} -->
          <p class="has-text-align-center has-large-font-size"></p>
          <!-- /wp:paragraph -->
        </div>
...
<!-- wp:group {"tagName":"section","align":"full","className":"is-style-show-mobile-tablet is-style-no-padding"} -->
<section class="wp-block-group alignfull is-style-show-mobile-tablet is-style-no-padding"><!-- wp:group {"align":"full","className":"is-style-no-padding","layout":{"type":"flex","orientation":"vertical"}} -->
  <div class="wp-block-group alignfull is-style-no-padding"><!-- wp:group {"style":{"layout":{"selfStretch":"fixed","flexSize":"30%"}},"layout":{"type":"constrained"}} -->
    <div class="wp-block-group"><!-- wp:image {"id":3500,"sizeSlug":"full","linkDestination":"none"} -->
      <figure class="wp-block-image size-full"><img src="https://wordpress.local/wp-content/uploads/2023/08/faqs.png" alt="" class="wp-image-3500" /></figure>
      <!-- /wp:image -->
    </div>
    <!-- /wp:group -->
